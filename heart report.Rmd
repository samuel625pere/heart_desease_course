...
The accuracy of the models on the test set are as follow: logistic regression `r print(glm_acc)`,
decision tree `r print(rpart_acc)`, random forest `r print(forest_acc)`, ensemble `r print(ens_acc)`.
The results of the models in the validation sets were as follow: ensemble `r print(final_accs[1])`,
logistic regression `r print(final_accs[2])`, decision tree `r print(final_accs[3])`,
random forest `r print(final_accs[4])`.
